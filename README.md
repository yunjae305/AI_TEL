...
감정 표현이 서튀러 말이 담백하지만, 그 안에 깊은 헌신이 있다. 지금의 소란에 휘슘리지 않고 몇 년 뒤에도 남을 것이 무엇인지를 먼저 본다.
...
2. 알림 받을 그룹(또는 채널)에 봇을 초대한다. 라이브용/브리핑용으로 그룹을 나눠도 되고, 같은 chat_id를 두 곳에 넣어 하나로 합쳤도 된다.
